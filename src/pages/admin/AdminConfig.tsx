...
export const AdminConfig: React.FC<{ onFeedback: (msg: string) => void }> = ({ onFeedback }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Cloud Database Sync */}
      <div className="p-6 sm:p-8 rounded-3xl bg-[#0E4A87]/70 border border-white/20 space-y-5">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-extrabold text-white flex items-center gap-2">
              <Cloud size={20} className="text-[#1976D2]" />
              Cloud Database Sync
            </h3>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <button
            ...
            className="px-5 py-2.5 rounded-xl bg-[#1976D2] hover:bg-[#42A5F5] text-white text-xs font-bold flex items-center gap-2 shadow-glow-blue-sm transition-all cursor-pointer"
          >
            <RefreshCw size={14} />
